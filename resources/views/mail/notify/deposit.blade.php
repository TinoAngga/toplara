                                    ...
                                    <td class="content-cell td-4">
                                        ...
                                        <table class="subcopy table-7" width="100%" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td class="td-6">
                                                    <p class="p">
                                                        - <b>Invoice:</b> {{ $deposit->invoice }}<br />
                                                        - <b>Pembayaran:</b> {{ $deposit->payment->name }}<br />
                                                        - <b>Jumlah:</b> Rp {{ currency($deposit->amount) }}<br />
                                                        - <b>Saldo:</b> Rp {{ currency($deposit->balance) }}<br />
                                                        - <b>Status:</b> {{ $deposit->status }}<br />
                                                        - <b>Alamat IP:</b> {{ $deposit->ip_address }}<br />
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
                                        @if ($deposit->status == 'pending' AND $deposit->is_paid == 0)
                                        <table class="subcopy table-7" width="100%" cellpadding="0" cellspacing="0"
                                            role="presentation">
                                            <tr>
                                                <td class="td-6">
                                        ...
                                        <table class="subcopy table-7" width="100%" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td class="td-6">
                                                    <p class="p" style="font-size: 14px;">
                                                        <br />
                                                        <a href="{{ url('deposit/invoice/' . $deposit->invoice) }}" class="btn-primary" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; color: #fff; text-decoration: none; line-height: 2em; font-weight: bold; text-align: center; cursor: pointer; display: inline-block; border-radius: 5px; text-transform: capitalize; background-color: #6e81dc; margin: 0; border-color: #6e81dc; border-style: solid; border-width: 10px 20px;">Deposit saya</a>
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
