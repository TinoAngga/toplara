...
<html lang="en">
    ...
    <head>
        ...
        <!-- Start CSS -->
        @yield('style')
        <link href="{{ asset('assets/light-horizontal/plugins/switchery/switchery.min.css') }}" rel="stylesheet" type="text/css">
        <link href="{{ asset('assets/light-horizontal/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css">
        <link href="{{ asset('assets/light-horizontal/css/icons.css') }}" rel="stylesheet" type="text/css">
        <link href="{{ asset('assets/light-horizontal/css/flag-icon.min.css') }}" rel="stylesheet" type="text/css">
        <link href="{{ asset('assets/light-horizontal/css/style.css') }}" rel="stylesheet" type="text/css">
        <link href="{{ asset('assets/light-horizontal/css/custom.css') }}" rel="stylesheet" type="text/css">
    ...
    <body class="horizontal-layout">
        ...
        <div id="containerbar" class="container-fluid">
            ...
            <div class="rightbar">
                                    ...
                                    <li class="list-inline-item">
                                        <div class="topbar-toggle-icon">
                                            <a class="topbar-toggle-hamburger" href="javascript:void();">
                                                <img src="{{ asset('assets/light-horizontal/images/svg-icon/horizontal.svg') }}" class="img-fluid menu-hamburger-horizontal" alt="horizontal">
                                                <img src="{{ asset('assets/light-horizontal/images/svg-icon/verticle.svg') }}" class="img-fluid menu-hamburger-vertical" alt="verticle">
                                             </a>
                                         </div>
                                    </li>
                                    <li class="list-inline-item">
                                        <div class="menubar">
                                            <a class="menu-hamburger navbar-toggle bg-transparent" href="javascript:void();" data-toggle="collapse" data-target="#navbar-menu" aria-expanded="true">
                                                <img src="{{ asset('assets/light-horizontal/images/svg-icon/collapse.svg') }}" class="img-fluid menu-hamburger-collapse" alt="collapse">
                                                <img src="{{ asset('assets/light-horizontal/images/svg-icon/close.svg') }}" class="img-fluid menu-hamburger-close" alt="close">
                                            </a>
                                         </div>
                                    </li>
                                </ul>
                                    ...
                                    <ul class="list-inline mb-0">
                                        ...
                                        <li class="list-inline-item">
                                            <a href="javascript:void(0)" id="infobar-settings-open" class="infobar-icon">
                                                <img src="{{ asset('assets/light-horizontal/images/svg-icon/settings.svg') }}" class="img-fluid" alt="settings">
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="profilebar">
                                                <div class="dropdown">
                                                  <a class="dropdown-toggle" href="#" role="button" id="profilelink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ asset('assets/light-horizontal/images/users/profile.svg') }}" class="img-fluid" alt="profile"><span class="feather icon-chevron-down live-icon"></span></a>
                ...
                <!-- End Navigationbar -->
                @include('primary.layouts.app.menu.light-horizontal')
                <!-- Start Breadcrumbbar -->
                    ...
                    <div class="row text-left mt-5 mb-5">
                            ...
                            <div class="row">
                                <div class="col-12 mb-2">
                                    <a href="https://api.whatsapp.com/send/?phone={{ getConfig('social_media_whatsapp') }}&text&app_absent=0"
                                        target="_blank" class="text-dark"><i class="fa fa-whatsapp mr-2"></i>{{ getConfig('social_media_whatsapp') }}</a>
                                </div>
                                <div class="col-12 mb-2">
                                    <a href="{{ getConfig('social_media_facebook_url') }}" target="_blank"><i
                                            class="fa fa-facebook-square"></i>&ensp;{{ getConfig('social_media_facebook_name') }}</a>
                                </div>
                                <div class="col-12 mb-3">
                                    <a href="https://instagram.com/{{ getConfig('social_media_instagram') }}" target="_blank" class="text-dark"><i
                                            class="fa fa-instagram mr-2"></i>{{ getConfig('social_media_instagram') }}</a>
                                </div>
                                <div class="col-12 mb-3">
                                    <a href="mailto:{{ getConfig('contact_email_address') }}" target="_blank" class="text-dark"><i
                        ...
                        <div class="col-md-4 mb-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <li><a href="{{ url('page/sitemap/' . $value->slug) }}" class="text-dark">{{ ucwords($value->title) }}</a></li>
                                </div>
                                @endforeach
                            </div>
                        </div>
        ...
        <!-- End Containerbar -->
        <!-- Start JS -->
        <script src="{{ asset('assets/light-horizontal/js/jquery.min.js') }}"></script>
        <script src="{{ asset('assets/light-horizontal/js/popper.min.js') }}"></script>
        <script src="{{ asset('assets/light-horizontal/js/bootstrap.min.js') }}"></script>
        <script src="{{ asset('assets/light-horizontal/js/modernizr.min.js') }}"></script>
        <script src="{{ asset('assets/light-horizontal/js/detect.js') }}"></script>
        <script src="{{ asset('assets/light-horizontal/js/jquery.slimscroll.js') }}"></script>
        <script src="{{ asset('assets/light-horizontal/js/horizontal-menu.js') }}"></script>
        <script src="{{ asset('assets/light-horizontal/plugins/switchery/switchery.min.js') }}"></script>
        <script>
            $.ajaxSetup({
                headers: {
        ...
        <!-- Core JS -->
        <script src="{{ asset('assets/light-horizontal/js/core.js') }}"></script>
