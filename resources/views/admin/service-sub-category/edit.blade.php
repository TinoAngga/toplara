<form method="post" action="{{ route('admin.'. request()->segment(2) .'.update', $serviceSubCategory->id) }}" id="main-form-modal" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="form-group">
        <label>Nama </label>
        <input type="text" class="form-control" name="name" value="{{ $serviceSubCategory->name }}">
