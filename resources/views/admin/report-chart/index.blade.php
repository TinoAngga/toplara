...
<div class="row">
    ...
    <div class="col-md-12 col-lg-12 col-xl-12">
        <div class="card m-b-30 shadow">
            <div class="card-header bg-primary">
                <h5 class="card-title mb-0 text-white font-weight-bold"><i class="mdi mdi-account-multiple-outline"></i> Peningkatan Pengguna
                </h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12 mb-2 mt-2">
                        <div class="card shadow">
                            <div class="card-header bg-primary">
                                <h5 class="card-title text-white mb-0 font-weight-bold"><i class="mdi mdi-account-multiple-outline"></i> Peningkatan Pengguna</h5>
                            </div>
                            <div class="card-body">
