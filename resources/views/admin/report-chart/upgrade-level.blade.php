...
<div class="row">
    ...
    <div class="col-md-12 col-lg-12 col-xl-12">
        <div class="card m-b-30 shadow">
            <div class="card-header bg-primary">
                <h5 class="card-title mb-0 text-white font-weight-bold"><i class="mdi mdi-account-multiple-outline"></i> Peningkatan Level Pengguna</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 mb-5">
                        {!! $userUpgradeChartLine->container() !!}
                    </div>
                    <hr>
                    <div class="col-md-12 mb-5">
                        {!! $userUpgradeChartPie->container() !!}
                    </div>
                </div>
            </div>
        </div>
...
@endsection
@section('script')
<script src="{{ $userUpgradeChartLine->cdn() }}"></script>

{{ $userUpgradeChartLine->script() }}
{{ $userUpgradeChartPie->script() }}
<script>
