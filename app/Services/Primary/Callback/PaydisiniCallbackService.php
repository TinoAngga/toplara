...
Class PaydisiniCallbackService
{

    public function handle($data)
    {
        $explodeMerchantRef = explode('-', $data->unique_code);
    ...
    {
        $deposit = Deposit::where('payment_gateway_request_response->data->unique_code', $data->unique_code)
                ->with('user', 'payment')
                ->first();
    ...
    {
        $order = Order::where('payment_gateway_request_response->data->unique_code', $data->unique_code)
                ->with('user', 'payment')
                ->first();
    ...
    {
        $userUpgrade = UserUpgrade::where('payment_gateway_request_response->data->unique_code', $data->unique_code)
                ->with('payment')
                ->first();
